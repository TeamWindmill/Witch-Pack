...
public class ShamanUIHandler : ClickableUIElement
{
    ...
    private void OnChangeHealth(Damageable arg1, DamageDealer arg2, DamageHandler arg3, BaseAbilitySO arg4, bool arg5)
    {
        OnChangeHealth();
    }
    ...
    private void ShamanDeathUI(Damageable arg1, DamageDealer arg2, DamageHandler arg3, BaseAbilitySO arg4)
    {
        Color upgradeColor = _upgradeFrame.color;
        upgradeColor.a = 0;
        _upgradeFrame.color = upgradeColor;
