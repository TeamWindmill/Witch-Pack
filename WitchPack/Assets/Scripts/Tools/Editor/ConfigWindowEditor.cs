...
public class ConfigWindowEditor : OdinMenuEditorWindow
{
    ...
    protected override OdinMenuTree BuildMenuTree()
    {
        ...
        tree.AddAllAssetsAtPath("Abilities/Shamans/AutoAttack",         "Assets/Configs/Abilities/Shamans",typeof(BaseAbility));
        tree.AddAllAssetsAtPath("Abilities/Shamans/Toor/Multishot",     "Assets/Configs/Abilities/Shamans/Toor/Multishot",typeof(BaseAbility));
        tree.AddAllAssetsAtPath("Abilities/Shamans/Toor/PiercingShot",  "Assets/Configs/Abilities/Shamans/Toor/PiercingShot",typeof(BaseAbility));
        tree.AddAllAssetsAtPath("Abilities/Shamans/Toor/Passives",      "Assets/Configs/Abilities/Shamans/Toor/Passives",typeof(BaseAbility));
        tree.AddAllAssetsAtPath("Abilities/Shamans/Nadia/RootingVines", "Assets/Configs/Abilities/Shamans/Nadia/RootingVines",typeof(BaseAbility));
        tree.AddAllAssetsAtPath("Abilities/Shamans/Nadia/Heal",         "Assets/Configs/Abilities/Shamans/Nadia/Heal",typeof(BaseAbility));
        tree.AddAllAssetsAtPath("Abilities/Shamans/Nadia/Passives",     "Assets/Configs/Abilities/Shamans/Nadia/Passives",typeof(BaseAbility));
        tree.AddAllAssetsAtPath("Abilities/Shamans/Javan/SmokeBomb",    "Assets/Configs/Abilities/Shamans/Javan/SmokeBomb",typeof(BaseAbility));
        tree.AddAllAssetsAtPath("Abilities/Shamans/Javan/Charm",        "Assets/Configs/Abilities/Shamans/Javan/Charm",typeof(BaseAbility));
        tree.AddAllAssetsAtPath("Abilities/Shamans/Javan/Passives",     "Assets/Configs/Abilities/Shamans/Javan/Passives",typeof(BaseAbility));
        tree.AddAllAssetsAtPath("Abilities/Enemies",                    "Assets/Configs/Abilities/Enemies",typeof(BaseAbility));
