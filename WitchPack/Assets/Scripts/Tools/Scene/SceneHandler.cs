...
namespace Tools.Scene
{
    public class SceneHandler : MonoBehaviour, ISceneHandler
    {
        ...
        public static UnityEngine.SceneManagement.Scene PresistanteScene { get; private set; }
        public static UnityEngine.SceneManagement.Scene CurrentScene { get; private set; }
        ...
        private IEnumerator LoadSceneAsync(SceneType sceneType)
        {
            ...
            UnityEngine.SceneManagement.Scene preventsScene = SceneManager.GetActiveScene();
        ...
        private IEnumerator SceneLoaderAndUnLoader(AsyncOperation asyncOperation)
        {
            ...
            {
                _loadTime += UnityEngine.Time.deltaTime;
