...
public class DotTimer : Timer
{
    ...
    public DotTimer(TimerData timerData, Action<DamageDealer, DamageHandler, BaseAbility, bool> onDot, DamageDealer damageDealer, DamageHandler damage, BaseAbility ability, bool isCrit) : base(timerData)
    {
    ...
    protected override void OnTimerTick() => OnDotTick?.Invoke(damageDealer, damage, ability, isCrit);
}
