...
namespace Gameplay.Wave
{
    public class WaveHandler : MonoBehaviour
    {
        ...
        [SerializeField] private Sprite enemyIndicatorIcon;
        ...
        private List<Visual.Indicator.Indicator> activeWaveIndicators;
        private LevelConfig _levelConfig;
        public void Init(LevelConfig levelConfig)
        {
            _levelConfig = levelConfig;
            spawnData = new List<EnemySpawnData>();
            activeWaveIndicators = new List<Visual.Indicator.Indicator>();
        ...
        private void SetIndicator(int waveIndex, float time = 0)
        {
            ...
            foreach (EnemyGroup group in spawnData[waveIndex].Groups)
            {
                ...
                Visual.Indicator.Indicator newIndicator = spawnPoint.SetIndicator(enemyIndicatorIcon, time, SkipWaveCD);
